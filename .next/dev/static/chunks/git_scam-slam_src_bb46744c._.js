...
function NameInput() {
    ...
    const handleContinue = async ()=>{
        ...
        setError("");
        try {
            const gameData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$git$2f$scam$2d$slam$2f$src$2f$lib$2f$data$3a$994da1__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createGame"])(name);
            dispatch({
                type: "SET_GAME_ID",
                payload: gameData.id
            });
...
_s(NameInput, "23hggjLUU97vboNTFg78hIrIny4=", false, function() {
    return [
...
//# sourceMappingURL=git_scam-slam_src_bb46744c._.js.map