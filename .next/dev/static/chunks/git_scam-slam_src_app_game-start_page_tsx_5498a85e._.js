...
"[project]/git/scam-slam/src/app/game-start/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GameStart() {
    ...
    const [count, setCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$git$2f$scam$2d$slam$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(3);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$git$2f$scam$2d$slam$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GameStart.useEffect": ()=>{
            ...
            const timer = setTimeout({
                "GameStart.useEffect.timer": ()=>{
                    setCount({
                        "GameStart.useEffect.timer": (prev)=>prev - 1
                    }["GameStart.useEffect.timer"]);
                }
            }["GameStart.useEffect.timer"], 1000);
            return ({
                "GameStart.useEffect": ()=>clearTimeout(timer)
            })["GameStart.useEffect"];
        }
    }["GameStart.useEffect"], [
        count,
...
_s(GameStart, "Ng92qNmla3zqipRZH/tvpttA4oU=", false, function() {
    return [
...
//# sourceMappingURL=git_scam-slam_src_app_game-start_page_tsx_5498a85e._.js.map