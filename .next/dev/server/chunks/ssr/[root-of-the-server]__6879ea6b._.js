...
"[project]/git/scam-slam/src/lib/utils/game.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$git$2f$scam$2d$slam$2f$src$2f$lib$2f$utils$2f$game$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/git/scam-slam/src/lib/utils/game.ts [app-ssr] (ecmascript)");
...
function GameProvider({ children }) {
   ...
   */ async function dispatch(action) {
        switch(action.type){
            ...
            case "CREATE_GAME":
                {
                    const game = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$git$2f$scam$2d$slam$2f$src$2f$lib$2f$utils$2f$game$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createGame"])(action.payload);
                    baseDispatch({
                        type: "SET_GAME_ID",
                        payload: game.id
                    });
       ...
       */ case "HANDLE_ANSWER":
                {
                    ...
                    if (action.payload.answer === state.currentQuestion.correctAnswer) {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$git$2f$scam$2d$slam$2f$src$2f$lib$2f$utils$2f$game$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["recordQuestionAttempt"])({
                            gameId: state.gameId,
                        ...
                        const scoreAwarded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$git$2f$scam$2d$slam$2f$src$2f$core$2f$game$2f$scoring$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateScoreIncrement"])(state.currentQuestion.difficulty, action.payload.timeLeft);
                        baseDispatch({
            ...
            case "UPDATE_GAME":
                {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$git$2f$scam$2d$slam$2f$src$2f$lib$2f$utils$2f$game$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateGame"])(state.gameId, {
                        score: state.score,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6879ea6b._.js.map