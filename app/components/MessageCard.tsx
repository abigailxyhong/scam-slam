...
export default function MessageCard({ message }: {message: MessageQuestion;}) {
    ...
    return (
        ...
        <div>
            <Image src={message.content?.imageURL || ""} alt="Message content image" width={message.content?.width || 300} height={message.content?.height || 200} />
        </div>

        // <div className="bg-zinc-200 p-6 rounded-xl shadow-inner w-2/5">
        //     {/* Phone frame */}
        //     {message && message.content.imageURL && (
        //         <div className="flex items-center justify-center">
        //             <Image src={message.content.imageURL} alt="Message content image" width={400} height={500} />
        //         </div>
        //     )}
        //     {message.content.customText && (
        //         <div className="bg-white rounded-2xl shadow-lg border overflow-hidden">
        //             {/* Header */}
        //             <div className="border-b justify-items-start px-2 py-2">
        ...
        //             {/* Header */}
        //             <div className="flex flex-row font-sans px-4 py-3 border-b bg-zinc-100 text-center">
